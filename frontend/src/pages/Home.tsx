...
import { UserObject } from "./components/MockUser";
function Home() {
  ...
  const dummyUser: UserObject[] = [
    {
      ...
      profilePicture: "https://res.cloudinary.com/aenetworks/image/upload/c_fill,w_1200,h_630,g_auto/dpr_auto/f_auto/q_auto:eco/v1/joe-biden-gettyimages-1267438366",
    },
  ...
  const dummyPosts: PostObject[] = [
    ...
    },
    {
      ...
      pureDescription: "Cooler Trip mit vielen Sehenswürdigkeiten",
      location: "Berlin",
    ...
    },
    {
      ...
      pureDescription: "Natur pur und frische Luft",
      location: "Alpen",
  ...
  return (
    <>
      ...
      {dummyPosts.map((post) => (
        <React.Fragment>
          <div className="flex flex-col items-center w-full h-full mx-auto  max-w-4xl border-4 border-red-600 rounded-lg mt-10">
            <div className="w-full">
              ...
              />
              <div className ="w-full border-4 border-yellow-500 rounded-lg ">
                <PostInfo post={post} />
              </div>
              
            </div>
            {/* Beschreibung des Posts */}
            <div className="w-full border-4 border-green-600 rounded-lg ">
